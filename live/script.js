...
function createProductCardElement(product) {
  ...
  card.innerHTML = `
    <div class="product-card-top-bar">
      ...
      <button class="card-wishlist-btn ${isWishlisted ? 'active' : ''}" onclick="toggleWishlist('${product.id}', event)" aria-label="Add to wishlist" title="Wishlist">
        <svg viewBox="0 0 24 24" fill="${isWishlisted ? '#E52E2E' : 'none'}" stroke="${isWishlisted ? '#E52E2E' : 'currentColor'}" stroke-width="2">
